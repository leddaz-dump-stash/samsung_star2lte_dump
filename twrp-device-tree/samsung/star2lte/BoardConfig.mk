...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := SRPQH16A017RU

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 44825120 # This is the maximum known partition size, but it can be higher, so we just omit it
